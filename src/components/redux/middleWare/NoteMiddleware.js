...
export const getData = ({ dispatch, getState }) => next => action => {
    if (action.type == "INIT_DATA") {
        ...
        fetch("https://box.dev.leader.codes/api/tehilaSH/note/getNotesByUserName", requestOptions)
    ...
    if (action.type == "CREATE_NOTE") {
        ...
        fetch("https://box.dev.leader.codes/api/tehilaSH/note/createNote", requestOptions)
